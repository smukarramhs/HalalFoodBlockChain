...
hurl invoke product product_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
hurl install product node -P ./chaincode-product
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install product node -P ./chaincode-product --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade product node 1.2 -P ./chaincode-product
```
...
# Upgrade your existing chaincode - From the root of your project
npm run cc:upgrade -- product 1.2
```
